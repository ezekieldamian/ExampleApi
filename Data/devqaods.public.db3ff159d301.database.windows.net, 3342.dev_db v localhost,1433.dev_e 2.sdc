...
SQL Data Compare
SQL Data Compare
Version:14.4.4.16824-->
<Project version="5" type="SQLComparisonToolsProject">
  <DataSource1 version="4" type="LiveDatabaseSource">
    <ServerName>devqaods.public.db3ff159d301.database.windows.net, 3342</ServerName>
    <DatabaseName>dev_db</DatabaseName>
    <Username>ezekiel.gallardo@empr.co</Username>
    <SavePassword>True</SavePassword>
    <Password encrypted="1">O92v6A1sQcMDdNuz8Umhmw==</Password>
    <ScriptFolderLocation />
    <MigrationsFolderLocation />
    <AuthenticationType>AzureActiveDirectoryPassword</AuthenticationType>
  </DataSource1>
  <DataSource2 version="4" type="LiveDatabaseSource">
    <ServerName>localhost,1433</ServerName>
    <DatabaseName>dev_e</DatabaseName>
    <Username>sa</Username>
    <SavePassword>True</SavePassword>
    <Password encrypted="1">MgZXhjN6TqjkMcCuntqxgQ==</Password>
    <ScriptFolderLocation />
    <MigrationsFolderLocation />
    <AuthenticationType>SqlPassword</AuthenticationType>
  </DataSource2>
  <LastCompared>11/23/2020 03:07:33</LastCompared>
